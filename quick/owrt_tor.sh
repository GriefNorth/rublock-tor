...
mkdir -p /usr/lib/lua /etc/rublock

echo install dependes
opkg remove dnsmasq
opkg install dnsmasq-full ipset iptables lua jq tor tor-geoip
wget -O /usr/lib/lua/ltn12.lua https://raw.githubusercontent.com/diegonehab/luasocket/master/src/ltn12.lua
wget -O /bin/blupdate.lua https://raw.githubusercontent.com/blackcofee/rublock-shadowsocks/master/owrt/bin/blupdate.lua
wget -O /bin/rublock.sh https://raw.githubusercontent.com/blackcofee/rublock-shadowsocks/master/owrt/bin/rublock.sh
ipset -N rublock nethash

echo execute script
chmod +x /bin/blupdate.lua /bin/rublock.sh
rublock.sh
